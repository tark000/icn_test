...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { discription1: @about.discription1, discription2: @about.discription2, image: @about.image, title: @about.title }
    end
  ...
  test "should update about" do
    put :update, id: @about, about: { discription1: @about.discription1, discription2: @about.discription2, image: @about.image, title: @about.title }
    assert_redirected_to about_path(assigns(:about))
  end
