...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { image: @bank.image, text: @bank.text, title: @bank.title, type_id: @bank.type_id }
    end
  ...
  test "should update bank" do
    put :update, id: @bank, bank: { image: @bank.image, text: @bank.text, title: @bank.title, type_id: @bank.type_id }
    assert_redirected_to bank_path(assigns(:bank))
  end
