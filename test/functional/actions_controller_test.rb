...
class ActionsControllerTest < ActionController::TestCase
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post :create, action: { discription: @action.discription, image: @action.image, text: @action.text, title: @action.title }
    end
  ...
  test "should update action" do
    put :update, id: @action, action: { discription: @action.discription, image: @action.image, text: @action.text, title: @action.title }
    assert_redirected_to action_path(assigns(:action))
  end
